            ...
            return (
                ...
                <div style={{textAlign: "center"}}>
                   ...
                   <Typography variant="body1" style={{fontFmaily: "Signika", color: "white"}}> Log Out</Typography>
                    ...
                    <Typography variant="h5" align="left" style={{color: "white", paddingLeft: 20}}> Employee </Typography>
                    ...
                    {this.state.page == "requests" ? 
                        <>
                            <RequestsDatabase type={"requests"} query={query(collection(db, "requests"), where("scheduled", "==", ""), where("completed", "==", false), orderBy("created", "desc"))} />
                            <RequestsMap query={query(collection(db, "requests"), where("scheduled", "==", ""), where("completed", "==", false), orderBy("created", "desc"))} />
                        </>
                        :
                        null
                    }
